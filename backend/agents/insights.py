...
Your task is to write a comprehensive 'Key Insights' section in Markdown.
Explain findings, trends, anomalies, and relationships in the data. Do NOT provide business recommendations yet, just pure analytical insights based on the data.
"""),
