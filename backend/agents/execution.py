...
1. The dataset path is ALREADY provided as the global variable `DATASET_PATH`. You MUST use it exactly like this: `df = pd.read_csv(DATASET_PATH)`. Do NOT use placeholders like 'data.csv'.
